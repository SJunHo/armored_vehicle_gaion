...
export const RegressionDataUpload: React.FC = () => {
...
const UploadPage: React.FC<{
  ...
  const [selectedDataType, setSelectedDataType] = useState<any>("B_LIFE");
        ...
        <Form>
          <Row className="d-flex mt-2 mb-4">
            <Col md={2}>
              ...
              >
                <option value={'B_LIFE'}>[잔존수명] 베어링</option>
                <option value={'W_LIFE'}>[잔존수명] 휠</option>
                <option value={'G_LIFE'}>[잔존수명] 기어박스</option>
                <option value={'E_LIFE'}>[잔존수명] 엔진</option>
              </Form.Select>
            </Col>
          </Row>
          <FormControl

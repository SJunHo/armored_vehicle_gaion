...
//                   return (
//                       <>
//                           <div style={{ backgroundColor: color, border: "thick double #DEE2E6", width: "115px" }}>
//                               {result}
//                           </div>
//                       </>
//                   )
...
//                   if (v.defectUser === 0) {
//                       result = "미 평가"
//                   }else if (v.defectUser === 10){
//                       result = "매우 양호"
//                       color = "#73CAF5"
//                   } else if (v.defectUser === 20) {
//                       result = "양호"
//                       color = "#78FF9E"
//                   } else if (v.defectUser === 30) {
//                       result = "적정"
//                       color = "#E4E86D"
//                   } else if (v.defectUser === 40) {
//                       result = "심각"
//                       color = "#FFD285"
//                   } else {
//                       result = "매우 심각"
...
//           },
//           {
//               Header: t("history.defect_result_compare").toString(),
//               accessor: (v: any) => {
//                   let checked
//                   let color
//
//                   if (v.defectScore === v.defectUser){
//                       checked = "far fa-check-circle fa-2x"
//                       color = "#4688FA";
//                   } else {
//                       checked = "far fa-times-circle fa-2x"
//                       color = "#FA6D62";
//                   }
//
//                   return (
//                       <>
//                           <div>
//                               <i className={checked} style={{color: color}}/>
//                           </div>
//                       </>
//                   )
//               }
...
//                   </Col>
//                   <Col xs={2}>
//                       <Button onClick={() => handleSearchData(paginate)}>
//                           {t("btn.search")}
//                       </Button>
//                   </Col>
//

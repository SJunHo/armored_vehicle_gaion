...
import { RandomForestClassificationResponse } from "../api/gen";
  ...
  return (
    <Card className="mt-3">
      ...
      <Card.Body className="d-grid gap-3 container-fluid">
        ...
        {(algorithmName === "kmean" || algorithmName === "if") && (
          <ClusterDiagram algorithmName={algorithmName} result={result} />
        )}
        <ClassificationResult algorithmName={algorithmName} result={result} />
      </Card.Body>
    </Card>
  );
};

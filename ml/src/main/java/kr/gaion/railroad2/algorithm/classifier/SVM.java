package kr.gaion.railroad2.algorithm.classifier;
...
import kr.gaion.railroad2.algorithm.dto.response.SVMClassificationResponse;
...
import kr.gaion.railroad2.spark.dto.PredictedLabeledData;
...
public class SVM extends ClassifierAlgorithm<LogisticRegressionModel> {
	public SVM(@NonNull ElasticsearchSparkService elasticsearchSparkService, @NonNull Utilities utilities, @NonNull StorageConfig storageConfig, @NonNull ModelUtilService modelUtil, @NonNull EsConnector esConnector, @NonNull FSChiSqSelector chiSqSelector, @NonNull AlgorithmConfig algorithmConfig, @NonNull DataConfig dataConfig, @NonNull ModelService modelService, @NonNull SparkSession sparkSession) {
		super(elasticsearchSparkService, utilities, storageConfig, modelUtil, esConnector, chiSqSelector, algorithmConfig, dataConfig, sparkSession, modelService, "SvmClassifier");
	}

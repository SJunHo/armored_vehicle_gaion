...
import kr.gaion.railroad2.algorithm.dto.response.RandomForestClassificationResponse;
...
public class RandomForestClassifier extends ClassifierAlgorithm<RandomForestClassificationModel> {
	public RandomForestClassifier(@NonNull ElasticsearchSparkService elasticsearchSparkService, @NonNull Utilities utilities, @NonNull StorageConfig storageConfig, @NonNull ModelUtilService modelUtil, @NonNull EsConnector esConnector, @NonNull FSChiSqSelector chiSqSelector, @NonNull AlgorithmConfig algorithmConfig, @NonNull DataConfig dataConfig, @NonNull SparkSession sparkSession, @NonNull ModelService modelService) {
		super(elasticsearchSparkService, utilities, storageConfig, modelUtil, esConnector, chiSqSelector, algorithmConfig, dataConfig, sparkSession, modelService, "RandomForestClassifier");
	}

...
public class KmeansClustering extends ClusterMlAlgorithm<KMeansModel> {
  ...
  public KmeansClustering(@NonNull ElasticsearchSparkService elasticsearchSparkService, @NonNull DatabaseSparkService databaseSparkService, @NonNull Utilities utilities, @NonNull StorageConfig storageConfig, @NonNull ModelUtilService modelUtil, @NonNull FSChiSqSelector chiSqSelector, @NonNull AlgorithmConfig algorithmConfig, @NonNull DataConfig dataConfig, @NonNull SparkSession sparkSession, @NonNull ModelService modelService, @NonNull PcaDimensionalityReduction dimensionalityReduction, @NonNull HdfsHelperService hdfsHelperService) {
		super(elasticsearchSparkService, databaseSparkService, utilities, storageConfig, modelUtil, chiSqSelector, algorithmConfig, dataConfig, sparkSession, "KmeansClustering", modelService, dimensionalityReduction);

...
//	@PreAuthorize("hasRole('USER') or hasRole('MODERATOR') or hasRole('ADMIN')")
	...
	public ResponseEntity<List<Map<String, Object>>> getFileWithId(@PathVariable("id") String id){
		try{
			List<Map<String, Object>> sdaData = vehicleStaticsService.getFileWithId(id);
	...
	@GetMapping("/findRecentFile/{sdaid}/{operdate}")
	public ResponseEntity<String> findRecentFile(@PathVariable("sdaid") String sdaid, @PathVariable("operdate") String operdate){
		try {
			String fileName = vehicleStaticsService.findRecentFile(sdaid,operdate);

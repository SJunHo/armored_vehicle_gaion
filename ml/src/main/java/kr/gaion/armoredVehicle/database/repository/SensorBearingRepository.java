...
public interface SensorBearingRepository extends JpaRepository<SensorBearing, Long> {
    ...
    List<Map<String, String>> getLeftBallAiLBSFPredictedData(String carId, LocalDate fromDate, LocalDate toDate);
    ...
    List<Map<String, String>> getLeftOutsideAiLBPFOPredictedData(String carId, LocalDate fromDate, LocalDate toDate);
    ...
    List<Map<String, String>> getLeftInsideAiLBPFIPredictedData(String carId, LocalDate fromDate, LocalDate toDate);
    ...
    List<Map<String, String>> getLeftRetainerAiLFTFPredictedData(String carId, LocalDate fromDate, LocalDate toDate);
    ...
    List<Map<String, String>> getRightBallAiRBSFPredictedData(String carId, LocalDate fromDate, LocalDate toDate);
    ...
    List<Map<String, String>> getRightOutsideAiRBPFOPredictedData(String carId, LocalDate fromDate, LocalDate toDate);
    ...
    List<Map<String, String>> getRightInsideAiRBPFIPredictedData(String carId, LocalDate fromDate, LocalDate toDate);
    ...
    List<Map<String, String>> getRightRetainerAiRFTFPredictedData(String carId, LocalDate fromDate, LocalDate toDate);

...
public interface TrainingGearboxRepository extends JpaRepository<TrainingGearbox, Long> {
    // Gearbox
    @Query(value = " SELECT g.AI_GEAR, g.W_RPM, g.G_V_OverallRMS, g.G_V_Wheel1X, g.G_V_Wheel2X, g.G_V_Pinion1X, g.G_V_Pinion2X, g.G_V_GMF1X, g.G_V_GMF2X, e.AC_h, e.AC_v, e.AC_a, g.`DATE` " +

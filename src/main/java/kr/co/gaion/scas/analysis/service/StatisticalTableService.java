...
import kr.co.gaion.scas.analysis.mapper.BkdsdaMapper;
import kr.co.gaion.scas.analysis.mapper.DtctsdaMapper;
import kr.co.gaion.scas.analysis.mapper.SdaMapper;
import kr.co.gaion.scas.analysis.mapper.StatsdaMapper;
	...
	public JSONObject findTable(String level, String url, Date date) {
		...
		if(level.equals("0")) {
			...
			for(TreeInfo c : childs) {
				...
				for(Sda s : sdaList) {
					int dr = statsdaMapper.countStatssda(s.getSdaid(),operdate);
					int ol = dtctsdaMapper.countDtctsdaBySdaid(s.getSdaid(),operdate);
					int bk = bkdsdaMapper.countBkdsdaBySdaid(s.getSdaid(),operdate);
